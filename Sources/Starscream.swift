...
////
//// Based on commit SHA 6e10c04c838, but without compression support.
//// Changed sha1Base64 implementation to use CryptoSwift SHA1 implementation.
////
//////////////////////////////////////////////////////////////////////////////////////////////////
//
//  SSLSecurity.swift
    ...
    */
    ...
    private func dequeueWrite(_ data: Data, code: OpCode, writeCompletion: (() -> ())? = nil) {
        ...
        operation.addExecutionBlock { [weak self, weak operation] in
            ...
            var offset = 2
            let firstByte:UInt8 = s.FinMask | code.rawValue
            var data = data
